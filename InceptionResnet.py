...
Model_InceptionResnet = tf.keras.applications.InceptionResNetV2(include_top=False, weights='imagenet',
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint("./checkpoint/Modified_InceptionResnet.h5", save_best_only=True, verbose=0),
...
names = ['Xception','VGG16','Mobilenet','VGG19','Inception','InceptionResnet']
current_model_name = names[5]
