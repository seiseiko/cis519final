...
Model_DenseNet201 = tf.keras.applications.DenseNet201(include_top=False, weights='imagenet',
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(128, activation='relu'), # Dense Layer 128 x 1 x 1
    tf.keras.layers.BatchNormalization(),
    tf.keras.layers.Dropout(0.2),
    tf.keras.layers.Dense(3, activation='sigmoid') # Dense Layer 3 x 1 x 1
])
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint("./checkpoint/Modified_DenseNet.h5", save_best_only=True, verbose=0),
...
names = ['Xception','VGG16','Mobilenet','VGG19','Inception','InceptionResnet','DenseNet']
current_model_name = names[6]
