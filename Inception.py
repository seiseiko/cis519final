...
model_InceptionV3 = tf.keras.applications.InceptionV3(include_top=False, weights='imagenet', input_shape=(IMAGE_HEIGHT, IMAGE_WIDTH, 3))
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint("./checkpoint/Modified_Inception.h5", save_best_only=True, verbose=0),
...
names = ['Xception','VGG16','Mobilenet','VGG19','Inception']
current_model_name = names[4]
