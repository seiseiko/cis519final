...
Model_EfficientNet = tf.keras.applications.efficientnet_v2.EfficientNetV2L(include_top=False, weights='imagenet',
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint("./checkpoint/Modified_EfficientNet.h5", save_best_only=True, verbose=0),
...
names = ['Xception','VGG16','Mobilenet','VGG19','Inception','InceptionResnet','EfficientNet']
